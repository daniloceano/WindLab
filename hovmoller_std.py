...
from ReadWindCube import WindOperationsAccessor
...
std_40m = ds.wind_cube.compute_std_detrended_data(ds.wind_cube.get_variable(40, 'Wind Speed (m/s)'), window=600)
std_60m = ds.wind_cube.compute_std_detrended_data(ds.wind_cube.get_variable(60, 'Wind Speed (m/s)'), window=600)
std_70m = ds.wind_cube.compute_std_detrended_data(ds.wind_cube.get_variable(70, 'Wind Speed (m/s)'), window=600)
std_100m = ds.wind_cube.compute_std_detrended_data(ds.wind_cube.get_variable(100, 'Wind Speed (m/s)'), window=600)
std_120m = ds.wind_cube.compute_std_detrended_data(ds.wind_cube.get_variable(120, 'Wind Speed (m/s)'), window=600)
std_150m = ds.wind_cube.compute_std_detrended_data(ds.wind_cube.get_variable(150, 'Wind Speed (m/s)'), window=600)
...
create_hovmoller_diagram(hovmoller_data_std, time, vertical_levels, '10-min Wind Std Dev (m/s)', 'Hovmöller Diagram: Wind Speed Std Dev Across Heights')
